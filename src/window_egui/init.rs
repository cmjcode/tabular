...
impl super::Tabular {
    ...
    pub fn new() -> Self {
        ...
        let mut app = Self {
            ...
            pending_callback_jobs: std::collections::HashMap::new(),
            deferred_callback_queries: Vec::new(),
            next_query_job_id: 1,
            ...
            sync_connections_push_receiver: None,
            ...
            vault_recovery_code_input: String::new(),
            vault_recovery_code_display: None,
            vault_recovery_code_saved_confirmed: false,
            vault_error: None,
            vault_check_receiver: None,
            vault_upload_receiver: None,
            vault_team_keys_receiver: None,
            vault_team_bootstrap_receiver: None,

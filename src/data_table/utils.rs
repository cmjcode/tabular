...
mod tests {
    ...
    fn test_parse_enum_values() {
        assert_eq!(
            parse_enum_values("enum('a','b')"),
            Some(vec!["a".to_string(), "b".to_string()])
        );
        assert_eq!(
            parse_enum_values("ENUM('YES','NO')"),
        ...
        assert_eq!(
            parse_enum_values("enum('O''Neil','Smith')"),
            Some(vec!["O'Neil".to_string(), "Smith".to_string()])
        );
        assert_eq!(parse_enum_values("varchar(255)"), None);
        // Test set
        assert_eq!(
            parse_enum_values("set('a','b')"),
            Some(vec!["a".to_string(), "b".to_string()])
        );
